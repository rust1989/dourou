...
if ( ! class_exists( 'GhostPool_Login' ) ) {
	class GhostPool_Login extends WP_Widget {
		...
		function __construct() {
			$widget_ops = array( 'classname' => 'gp-login-widget', 'description' => esc_html__( 'Display a login widget.', 'buddy' ) );
			parent::__construct( 'gp-login-widget', esc_html__( 'GP Login Form', 'buddy' ), $widget_ops );
		}
