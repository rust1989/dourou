		...
		<li <?php bp_group_class(); ?>>
			...
			<div class="gp-group-box">
				...
				<div class="item">
					...
					<div class="item-meta"><span class="activity"><?php printf( esc_html__( 'active %s', 'buddy' ), bp_get_group_last_active() ); ?></span></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php esc_html_e( 'There were no groups found.', 'buddy' ); ?></p>
	</div>
